...
from services.state.ui.style_loader import load_css, inject_local_font, inject_webrtc_styles
...
def main():
    ...
    inject_local_font(os.path.join("static", "AdobeClean.otf"), "AdobeClean")
