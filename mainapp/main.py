...
from services.persistence.exercise_repository import add_exercise, init_db
...
def main():
        ...
        if not workout_started:
            ...
            if end_session_button:
                ...
                if sets_completed > 0:
                    ...
                    sets_completed,
                    int(time.time() - st.session_state.set_cycle_started_at)
                    )
    ...
    if st.session_state.get("audio_to_play"):
        print("Audio Path:", st.session_state.audio_to_play)
